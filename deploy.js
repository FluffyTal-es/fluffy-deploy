...
const getRemoteDestinationFolder = (name) => {
  ...
  else if (name.indexOf('fluffy-car-addons') !== -1) return '[fluffy-moddedcars]/[fluffy-car-addons]'
  else if (name.indexOf('fluffy-car-mdfd') !== -1) return '[fluffy-moddedcars]/[fluffy-car-mdfd]'
  else if (name.indexOf('fluffy-car-pdsd') !== -1) return '[fluffy-moddedcars]/[fluffy-car-pdsd]'
  else if (name.indexOf('fluffy-car-event') !== -1) return '[fluffy-moddedcars]/[fluffy-car-event]'
  else if (name.indexOf('fluffy-car-import-am') !== -1) return '[fluffy-moddedcars]/[fluffy-car-import-am]'
  else if (name.indexOf('fluffy-car-import-nz') !== -1) return '[fluffy-moddedcars]/[fluffy-car-import-nz]'
